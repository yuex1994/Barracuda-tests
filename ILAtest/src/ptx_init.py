...
TMP_DIR = 'tmp/'
# TODO(Yue Xing): get a structure data, or protobuf to store each info 
# for the tests.
...
if __name__ == '__main__':
    ...
    diff_read_only_regs_obj = open(TMP_DIR + 'diff_read_only_regs', 'w')
#default
################################################################
###################Def##########################################
...
###########################  Start  ######################################
    ...
    if test_name == 'matrixMul_kernel':
        ...
        parameter_regs_obj = open(TMP_DIR + 'parameter_regs', 'w')
        ...
        buildin_regs_obj = open(TMP_DIR + 'buildin_regs', 'w')
        buildin_regs = {}
        buildin_regs['%nctaid.x'] = ctaid_x
        buildin_regs['%ntid.x'] = tid_x
        ...
        shared_read_only_range_regs_obj = open(TMP_DIR + 'shared_read_only_range_regs', 'w')
        shared_read_only_range_regs = {}
